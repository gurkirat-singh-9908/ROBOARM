...
theeta = sp.symbols('theeta1 theeta2 theeta3 theeta4 theeta5 theeta6')
link = sp.symbols('link0 link1 link2 link3 link4 link5')
...
dh_matrix = [
        [theeta[0]        , +sp.pi/2, 0.0     , link[0]],
        [theeta[1]+sp.pi/2, 0.0     , +link[1], 0.0],
        [theeta[2]        , +sp.pi/2, 0.0     , 0.0],
        [theeta[3]        , -sp.pi/2, 0.0     , link[2] + link[3]],
        [theeta[4]        , +sp.pi/2, 0.0     , 0.0]              ,
...
def main():
    ...
    sp.pprint(T_36[0,2], use_unicode=True)
